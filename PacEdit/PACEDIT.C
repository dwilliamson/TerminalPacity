...
//   Bline(0, 176, 319, 176, 40);
//   Bline(319, 0, 319, 176, 40);
                      ...
                      sprite_ptr loadar)
{
   ...
   Sprite_Init((sprite_ptr)&enemy, 100, 100, 0, 0, 0, 0, 16, 16, 6);
}
...
//                  video_buffer[(my * 320) + mx] = 40;
                  video_buffer[(my * 320) + mx] = 155;
               }
            }
//            Bline(20, 20, 159, 20, 34);
//            Bline(20, 20, 20, 69, 34);
            Bline(20, 20, 159, 20, 193);
            Bline(20, 20, 20, 69, 193);
//            Bline(20, 69, 159, 69, 137);
//            Bline(159, 20, 159, 69, 137);
         ...
         if (mouse.x >= 144 && mouse.x < 160 && mouse.y >= 178 &&
             mouse.y < 192 && sprite_count < 61 && state == 1)
         {
            sprite_count++;
            Mouse_Function(mouse.x, mouse.y);
            Display_Sprite_Bar((sprite_ptr)&blocks);
...
//            Bline(159, 20, 159, 69, 137);
             ...
             mouse.y < 192 && state == 1)
         {
            ...
            memset(filename_store, 0, ((mod + 1) * 12));
            filecnt = mod;
            mod = 0;
            rc = _dos_findfirst("*.TPE", _A_NORMAL, &fileinfo);
               ...
               if (level_store[offset] != 65 && level_store[offset] < 68)
               {
                  ...
                  if (enemy.curr_frame == 4)
                  {
                     ...
                     if (screen_x == pscx && screen_y == pscy && (psbx != (enemy.x / 16) || psby != (enemy.y / 16)))
                     {
                        ...
                        if (dgrid)
                        {
//                           Bline(enemy.x, enemy.y, enemy.x + 15, enemy.y, 40);
//                           Bline(enemy.x, enemy.y, enemy.x, enemy.y + 15, 40);
...
//!@#
         ...
         if (mouse.y >= 26 && mouse.y < 34 && state == 4)
         {
            if (mouse.x >= 24 && mouse.x < 40)
            {
               ...
               if (dgrid)
               {
//                  Bline(blocks.x, blocks.y, blocks.x + 15, blocks.y, 40);
//                  Bline(blocks.x, blocks.y, blocks.x, blocks.y + 15, 40);
...
//               Bline(20, 20, 76, 20, 34);
//               Bline(20, 20, 20, 39, 34);
               Bline(20, 20, 76, 20, 193);
               Bline(20, 20, 20, 39, 193);
//               Bline(20, 39, 76, 39, 137);
//               Bline(76, 20, 76, 39, 137);
